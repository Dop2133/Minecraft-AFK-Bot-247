...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'CuidadPanAnarquico.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 45328,                // Puerto predeterminado de Minecraft
        username: 'Raboot123',    // Nombre genérico del bot/NPC dentro del juego
